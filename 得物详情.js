...
const obj = (function (eBreezy) {
    ...
    Hn = function (t, e) {
      for (
        ...
        switch (Ee[o++] ^ a) {
          ...
          case g:
            if (((a = j), t))
              for (n = jt; n < t; n++) i[n] = r[jt | (Math.random() * e)];
            else {
              var c = void 0;
              for (
                i[et] = i[de] = i[nn] = i[me] = "-", i[zt] = "4", n = jt;
                ke(n, Wt);
                n++
              )
                i[n] ||
                  ((c = jt | Lt(Math.random(), B)),
                  (i[n] = r[Rt(n, Ft) ? (c & In) | et : c]));
            }
            continue;
        }
        break;
  ...
  function zn(t) {
    ...
    function f(t) {
      var e,
        ...
        r = "";
      for (e = jt; A(e, In); e++)
        (r = Ie("0", ((t >>> (e * et)) & ot).toString(B))),
          (n = Ie(n, r.substr(r.length - kt, kt)));
      return n;
    }
    var l,
      p,
        ...
        (t = (function (t) {
          ...
          for (var e = "", n = jt; n < t.length; n++) {
            ...
            ke(r, ue)
              ...
              : r < en
              ? ((e += String.fromCharCode((r >> On) | Ne)),
                (e += String.fromCharCode((r & ht) | ue)))
              : ke(r, C)
              ? ((e += String.fromCharCode((r >> je) | se)),
                (e += String.fromCharCode(((r >> On) & ht) | ue)),
                (e += String.fromCharCode((r & ht) | ue)))
              : ((e += String.fromCharCode((r >> nn) | Y)),
                (e += String.fromCharCode(((r >> je) & ht) | ue)),
                (e += String.fromCharCode(((r >> On) & ht) | ue)),
                (e += String.fromCharCode((r & ht) | ue)));
          }
          return e;
  ...
  for (
    var Wn = [],
      ...
      Kn = (function (t, e) {
        ...
        "undefined" == typeof Uint8Array ? "undefined" : i(Uint8Array),
        "undefined"
      )
        ? Uint8Array
        : Array,
  ...
  function Zn(t, e, n) {
    for (var r, i = [], o = e; ke(o, n); o += In)
      (r = Ie((t[o] << B) + (t[o + Pn] << et), t[Ie(o, kt)])), i.push(Qn(r));
    return i.join("");
  }
  function Qn(t) {
    return Ie(
      Ie(Wn[(t >> nn) & ht], Wn[(t >> je) & ht]) + Wn[(t >> On) & ht],
      Wn[t & ht]
    );
  }
  function tr(t) {
    ...
    for (e = jt; e < n; e += b)
      (r =
        (Gn[t.charCodeAt(e)] << nn) |
        (Gn[t.charCodeAt(Ie(e, Pn))] << je) |
        (Gn[t.charCodeAt(Ie(e, kt))] << On) |
        Gn[t.charCodeAt(e + In)]),
        (o[c++] = (r >> B) & ot),
        (o[c++] = (r >> et) & ot),
        (o[c++] = r & ot);
    return (
      Rt(i, kt)
        ? ((r =
            (Gn[t.charCodeAt(e)] << kt) | (Gn[t.charCodeAt(Ie(e, Pn))] >> b)),
          (o[c++] = r & ot))
        : i === Pn &&
          ((r =
            (Gn[t.charCodeAt(e)] << te) |
            (Gn[t.charCodeAt(e + Pn)] << b) |
            (Gn[t.charCodeAt(Ie(e, kt))] >> kt)),
          (o[c++] = (r >> et) & ot),
          (o[c++] = r & ot)),
      o
    );
  ...
  function er(t) {
    for (var e, n, r = [], i = jt, o = ye; ; ) {
      switch (Ee[i++] ^ o) {
        case Qe:
          o = rt;
          for (var a = jt; ke(a, e); a++)
            (n = t.charCodeAt(a)) >= C && A(n, We)
              ? (r.push(((n >> nn) & Re) | Y),
                r.push(((n >> je) & ht) | ue),
                r.push(((n >> On) & ht) | ue),
                r.push((n & ht) | ue))
              ...
              ? (r.push(((n >> je) & Tt) | se),
                ...
                r.push((n & ht) | ue))
              : n >= ue && A(n, Le)
              ? (r.push(((n >> On) & wn) | Ne), r.push((n & ht) | ue))
              : r.push(n & ot);
          continue;
        case [(o = B), It][Pn]:
          e = t.length;
  ...
  function nr(t) {
    for (
      var e, n = t.length, r = n % In, i = "", o = [], a = fn, c = jt, u = Se;
      ;
      ...
      switch (Ee[c++] ^ u) {
        ...
        case Re:
          ...
          continue;
        case [(u = je), vt][Pn]:
          for (var s = jt, l = I(n, r); ke(s, l); s += a)
            o.push(Zn(t, s, ne(Ie(s, a), l) ? l : Ie(s, a)));
          continue;
      }
      break;
    }
  ...
  function ar(t, e, n) {
    ...
    var a = nr(
        er(
          rr(
            "cSwYtmnBrCzOeX14",
            zn(i ? "".concat(i).concat($n) : r || $n).toString()
          )
        )
      ),
      c = jt;
        ...
        case Ae:
          for (o = Mt; ke(r, t.length); ) {
            ...
            (n += String.fromCharCode(f)),
              u !== ge && (n += String.fromCharCode(l)),
              s !== ge && (n += String.fromCharCode(p));
          }
          continue;
        case [(o = w), me][Pn]:
  ...
  function dr(t, e, n) {
    ...
    function r(t, e, r, i) {
      ...
      try {
        (o = hr(a, "AUIDFTY4473768U92SGDUHDITJF")),
          console.log("成功加密后", o);
      } catch (t) {
  ...
  function hr(t, e) {
    t = t || "";
    for (
      var n = e, r = "", i = [], o = [], a = n.length, c = t.length, u = jt;
      ke(u, at);
      u++
    )
      (i[u] = n[an(u, a)].charCodeAt()), (o[u] = u);
    ...
    return (function (t) {
      for (var e = "", n = t.length, r = jt; ke(r, n); r++)
      ...
      return (function (t) {
        ...
        for (; ke(r, t.length); ) {
          var i = t.charCodeAt(r++),
            ...
            u = c & ht;
          n += Ie(
            Ie(e[(c >> nn) & ht] + e[(c >> je) & ht], e[(c >> On) & ht]),
            e[u]
          );
        }
        var s = t.length % In,
  ...
  (Gn["-".charCodeAt(jt)] = P), (Gn["_".charCodeAt(jt)] = ht);
  tbreezy.exports = {
      ...
      for (var o = jt, a = dt; ; ) {
        switch (Ee[o++] ^ a) {
          case [(a = Zt), pt][Pn]:
            ...
            continue;
          case on:
            (a = qe), (Dn = r.getStorageSync("enT") || "1");
        }
        break;
      }
      for (var c = "", u = "0", s = t, f = e || "post", l = jt, p = ct; ; ) {
        switch (Ee[l++] ^ p) {
          case [(p = Q), un][Pn]:
    ...
    getSk: function (t) {
      for (var e, n = jt, r = rt; ; ) {
        switch (Ee[n++] ^ r) {
          ...
          case [(r = Wt), Q][Pn]:
            Rt(t, "wx")
              ? (e = wx.getStorageSync("sk")
                  ? wx.getStorageSync("sk").split("​")[jt]
                  : "")
              : Rt(t, "qq")
              ? (e = qq.getStorageSync("sk")
                  ? qq.getStorageSync("sk").split("​")[jt]
                  : "")
              : Rt(t, "dy")
              ? (e = tt.getStorageSync("sk")
                  ? tt.getStorageSync("sk").split("​")[jt]
                  : "")
              : Rt(t, "bd")
              ? (e = swan.getStorageSync("sk")
                  ? swan.getStorageSync("sk").split("​")[jt]
                  : "")
              : "zfb" === t &&
                (e = my.getStorageSync({
                  key: "sk",
    ...
    getRtk: function (t, e) {
      ...
      for (
        var a, c = Math.floor(new Date().valueOf() / hn), u = jt, s = nn;
        ;
