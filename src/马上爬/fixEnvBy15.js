...
function init(n = arr1, t = arr2) {
        ...
        (l[e[104]][w + m + I + u] = function () {
          for (
            ...
            for (
              ...
              (c[d] = l & parseInt(t[77], n[78])), --p != r[52];
  ...
  !(function (n) {
    ...
    function w(n) {
      for (var t = c[112], i = r[52], v = n[s[111]], f = []; i < v; ) {
        var l =
          (n[i++] << parseInt(C + t, c[113])) | (n[i++] << e[82]) | n[i++];
        f.push(
    ...
    function D(n) {
      ...
      var a = t[c[0]],
        o = [];
      return (
        g(t, +parseInt(e[79], c[122]), o, +u[2], a), x(o) == a ? o : void 0
      );
    }
    function x(n) {
      var t = o;
  ...
  !(function (n) {
      ...
      var t = u[8],
        ...
        i = function (n, o) {
          ...
          for (
            ...
            if (
              ((l = f[p].split(v(r[106], c[134]))), l && !(l[r[56]] < s[122]))
            ) {
    ...
    function S(n, t) {
      ...
      if (n) {
        ...
        if (f) {
          var l = f[u[0]];
          return (
            t && s.test(l) && (l = l.split(r[118]).pop().split(r[107])[c[2]]), l
          );
        }
      }
    }
    ...
    function z(n) {
      for (
        var t = v(O, u[163]), a = e[136], o = s[2], i = n[V + t + a] - s[0];
        i >= r[52];
        i--
      )
        o = (o << r[54]) | +n[i];
