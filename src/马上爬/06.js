...
async function parseInfo(i) {
    const url = `https://www.mashangpa.com/api/problem-detail/6/data/`;
    s();
    const res = await axios({
        ...
        headers: {
            ...
            cookie:
                "sessionid=800maoqstt96gvfp25opcs7tnatftlqc; Hm_lvt_0d2227abf9548feda3b9cb6fddee26c0=1751470476,1751470614; HMACCOUNT=15A4D224E171B74F; Hm_lpvt_0d2227abf9548feda3b9cb6fddee26c0=1751470768",
            "User-Agent":
                "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Safari/537.36",
        },
    });
    const plainText = xxxxoooo(res.data.t);
